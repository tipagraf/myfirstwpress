  ...
  <!-- Каталог    -->
  <!-- от $settings до wp_reset вставляет фон через рубрику создаем невидимую рубрику настройки -->
	<?php  
	$settings = get_posts([
		'numberposts' => 1,
	...
	?>	
		<div class="container">
			...
			<div class="category-controll text-center">
				...
				<button class="btn" type="button" data-filter=".<?php echo get_category(15, ARRAY_A)['slug'] ?>"><?php
				 echo get_category(15, ARRAY_A)['name'] ?></button>
				<button class="btn" type="button" data-filter=".<?php echo get_category(16, ARRAY_A)['slug'] ?>"><?php
				 echo get_category(16, ARRAY_A)['name'] ?></button>
				<button class="btn" type="button" data-filter=".<?php echo get_category(17, ARRAY_A)['slug'] ?>"><?php
				 echo get_category(17, ARRAY_A)['name'] ?></button>

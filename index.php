					...
					<div class="header-inner">
						<div class="header-catalog">
							...
							<?php 
								...
								?>								
								<div class="door">									
									<div class="name" style="background-image: url(<?php echo $row['catalog_img']; ?>)"><?php echo $row['catalog_text']; ?></div>
								</div>
								<?php
								}
								?>																
						...
						<div class="header-order">
							...
							<?php 
								...
								?>								
								<div class="door">									
									<div class="name" style="background-image: url(<?php echo $row['order_img']; ?>)"><?php echo $row['order_text']; ?></div>
								</div>
								<?php
								}
								?>								
	...
	<div class="contacts" style="background-image: url(<?= CFS()->get('form_bg'); ?>)">
		<div class="container">
			<div class="row">
				...
				<?php 
                $posts = get_posts([
                    'numberposts' => 2, /* если 'numbers' => -1 то без ограничений */
                    'category_name' => 'form',
                    'orderby' => 'title',
                    'order' => 'ASC',
                    'post_type' => 'post',
